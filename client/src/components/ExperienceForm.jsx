import { Briefcase, DivideCircle, Loader2, Plus, Sparkle, Sparkles, Trash2 } from 'lucide-react'
...
const ExperienceForm = ({data, onChange}) => {
    ...
    const generateDescription = async (index) => {
        ...
        const prompt = `enhance this job description ${experience.description} for the position of ${experience.position} at ${experience.position} at ${experience.company}.`;
