...
const ResumeBuilder = () => {
  ...
  const sections = [
    ...
    {id: "summary", name: "personal Info", icon: FileText},
      ...
      <div className='max-w-7xl mx-auto px-4 pb-8'>
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-xl border-gray-200 p-6 pt-1'>
              ...
              <button onClick={()=> {toast.promise(saveResume, {loading: 'Saving...'})}} className='bg-gradient-to-br from-green-200 ring-green-300 text-green-600 ring hover:ring-green-400 transition-all rounded-md px-6 py-2 text-sm'>
                Save Changes
              </button>
            </div>
          </div>
